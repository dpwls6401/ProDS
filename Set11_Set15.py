...
data11 = pd.read_csv('/Users/yejin/ProDS/Dataset/Dataset_11.csv')
data11.columns
...
pos1 = pd.read_csv('/Users/yejin/ProDS/Dataset/Dataset_05_Mart_POS.csv')
list1 = pd.read_csv('/Users/yejin/ProDS/Dataset/Dataset_05_item_list.csv')
...
# 1. 가장 많은 제품이 팔린 날짜에 날짜 빈도 이용해 일자별 판매 수 도출
...
q2 = pd.pivot_table(merge2, index='Date', columns='week',
...
# 1. 1년 동안 가장 많이 판매된 10개 상품을 주력상품으로 설정
# => 10개 주력 상품 목록 도출
...
# 2. 요일별 주력상품의 판매 개수: 일자별 주력상품 수를 산출, 요일별로 그룹
